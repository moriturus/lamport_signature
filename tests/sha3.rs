...
#[test]
fn test_sign_then_verify_sha3_256_private_key() {
...
#[test]
fn test_sign_then_verify_sha3_512_private_key() {
    const DATA: &'static [u8] = b"hello, world!";
...
#[test]
#[should_panic]
fn test_sign_then_verify_sha3_256_private_key_reuse_should_panic() {
    const DATA: &'static [u8] = b"hello, world!";
...
#[test]
#[should_panic]
fn test_sign_then_verify_sha3_512_private_key_reuse_should_panic() {
    const DATA: &'static [u8] = b"hello, world!";
    const SECOND_DATA: &'static [u8] = b"bello, vorld?";
